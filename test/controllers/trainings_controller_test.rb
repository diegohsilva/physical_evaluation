...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { date_end: @training.date_end, date_start: @training.date_start, description: @training.description, name: @training.name, student_id: @training.student_id }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { date_end: @training.date_end, date_start: @training.date_start, description: @training.description, name: @training.name, student_id: @training.student_id }
    assert_redirected_to training_path(assigns(:training))
  end
