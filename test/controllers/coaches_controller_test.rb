...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { celphone: @coach.celphone, cpf: @coach.cpf, cref: @coach.cref, email: @coach.email, name: @coach.name, telefone: @coach.telefone }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { celphone: @coach.celphone, cpf: @coach.cpf, cref: @coach.cref, email: @coach.email, name: @coach.name, telefone: @coach.telefone }
    assert_redirected_to coach_path(assigns(:coach))
  end
