...
class EvaluatorsControllerTest < ActionController::TestCase
  ...
  test "should create evaluator" do
    assert_difference('Evaluator.count') do
      post :create, evaluator: { cpf: @evaluator.cpf, email: @evaluator.email, name: @evaluator.name, phone: @evaluator.phone }
    end
  ...
  test "should update evaluator" do
    patch :update, id: @evaluator, evaluator: { cpf: @evaluator.cpf, email: @evaluator.email, name: @evaluator.name, phone: @evaluator.phone }
    assert_redirected_to evaluator_path(assigns(:evaluator))
  end
